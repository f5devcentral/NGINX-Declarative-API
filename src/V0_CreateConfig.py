...
def createconfig(declaration: ConfigDeclaration, apiversion: str):
    ...
    j2_env = Environment(loader=FileSystemLoader(NcgConfig.config['templates']['root_dir']+'/'+apiversion), trim_blocks=True)
    ...
    if decltype.lower() == "plaintext":
        ...
        f = open(NcgConfig.config['templates']['root_dir'] + '/' + apiversion + '/' + NcgConfig.config['templates']['nginxmain'], 'r')
        ...
        f = open(NcgConfig.config['templates']['root_dir'] + '/' + apiversion + '/' + NcgConfig.config['templates']['mimetypes'], 'r')
