...
def createAPIGateway(locationDeclaration: dict, authProfiles: Authentication={}):
    ...
    if locationDeclaration['apigateway']['openapi_schema']:
        status, apiSchemaString = v5_3.GitOps.getObjectFromRepo(object=locationDeclaration['apigateway']['openapi_schema'],
        ...
        if v5_3.MiscUtils.yaml_or_json(apiSchemaString['content']) == 'yaml':
            ...
            apiSchemaString['content'] = v5_3.MiscUtils.yaml_to_json(apiSchemaString['content'])
