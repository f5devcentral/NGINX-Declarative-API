...
| Control plane            | API v5.0     | API v5.1             | Notes         |
|--------------------------|--------------|----------------------|---------------|
| NGINX Instance Manager   | 2.14+        | 2.16+                |               |
| NGINX One Cloud Console  | Early access | General Availability |               |


### NGINX `http` and `stream` servers

| Feature                    | API v5.0 | API v5.1 | Notes                                                                                                                                                                                                               |
|----------------------------|---------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| per-URI client authentication                | X                                  | <li>Static JWT key</li><li>JWT key fetched from URL</li><li>Bearer token</li> |                                         |
| per-URI client authorization                 | X                                  | <li>JWT claims</li>                                                           |                                         |
...
| Type | Description          | API v5.0 | API v5.1                            | Notes                               |
|------|----------------------|----------|-------------------------------------|-------------------------------------|
| jwt  | Java Web Token (JWT) | X        | X                                   |                                     |
| mtls | Mutual TLS           | X        | <li>Supported for HTTP servers</li> | <li>Supported for HTTP servers</li> |
...
| Hook type         | API v5.0 | API v5.1 | Notes                                                                                                                        |
|-------------------|----------|----------|------------------------------------------------------------------------------------------------------------------------------|
